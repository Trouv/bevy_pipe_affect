...
- API reference on [docs.rs](https://docs.rs/bevy_pipe_affect/0.3.0/bevy_pipe_affect/) <!-- x-release-please-version -->
- Tutorials, Explanation, and Guides in the [`bevy_pipe_affect` book](https://trouv.github.io/bevy_pipe_affect/v0.3.0/index.html) <!-- x-release-please-version -->
