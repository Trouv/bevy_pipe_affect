...
For more code examples of `Effect`s, please explore the [`effects` module api reference](https://docs.rs/bevy_pipe_affect/0.3.1/bevy_pipe_affect/effects/index.html). <!-- x-release-please-version -->
