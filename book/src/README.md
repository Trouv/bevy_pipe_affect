...
- [*effects* module api reference](https://docs.rs/bevy_pipe_affect/0.3.0/bevy_pipe_affect/effects/index.html) (discover what effects are available, with examples!) <!-- x-release-please-version -->
