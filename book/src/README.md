...
For that, please refer to `bevy_pipe_affect`'s documentation on [docs.rs](https://docs.rs/bevy_pipe_affect/0.4.0/bevy_pipe_affect). <!-- x-release-please-version -->
...
- [*effects* module api reference](https://docs.rs/bevy_pipe_affect/0.4.0/bevy_pipe_affect/effects/index.html) (discover what effects are available, with examples!) <!-- x-release-please-version -->
...
`bevy_pipe_affect`'s [source code](https://github.com/Trouv/bevy_pipe_affect/tree/v0.4.0) is available on github. <!-- x-release-please-version -->
This repository also contains [cargo examples](https://github.com/Trouv/bevy_pipe_affect/tree/v0.4.0/examples), which can be run after cloning the repository using `$ cargo run --release --all-features --example example-name`. <!-- x-release-please-version -->
