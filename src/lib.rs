...
//! [`bevy_pipe_affect` book](https://trouv.github.io/bevy_pipe_affect/v0.3.1). <!-- x-release-please-version -->
//!
...
//! [github repository](https://github.com/Trouv/bevy_pipe_affect/tree/v0.3.1/examples). <!-- x-release-please-version -->
//!
//! ## Feature flags
