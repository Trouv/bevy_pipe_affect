...
//! [`bevy_pipe_affect` book](https://trouv.github.io/bevy_pipe_affect/v0.4.0). <!-- x-release-please-version -->
//!
...
//! [github repository](https://github.com/Trouv/bevy_pipe_affect/tree/v0.4.0/examples). <!-- x-release-please-version -->
//!
//! ## Feature flags
